...
#
# Script generated by Vivado on Wed Mar 25 10:50:45 +0530 2026
...
#
# Usage        : c_counter_binary_0.sh
#                c_counter_binary_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_counter_binary_0.sh [-reset_run]
#                c_counter_binary_0.sh [-reset_log]
#                c_counter_binary_0.sh [-help]
#
...
# script info
echo -e "c_counter_binary_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_counter_binary_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_20 -L c_counter_binary_v12_0_21 -L secureip -L xpm --snapshot c_counter_binary_0 xil_defaultlib.c_counter_binary_0 -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb c_counter_binary_0.wdb xsim.dir libdpi.so)
...
Usage: c_counter_binary_0.sh [-step]\n\
Usage: c_counter_binary_0.sh [-lib_map_path]\n\
Usage: c_counter_binary_0.sh [-reset_run]\n\
Usage: c_counter_binary_0.sh [-reset_log]\n\
Usage: c_counter_binary_0.sh [-keep_index]\n\
