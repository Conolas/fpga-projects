...
REM
REM Generated by Vivado on Sat Mar 28 12:02:16 +0530 2026
...
echo "xvlog --incr --relax -prj sca_mul_tb_vlog.prj"
call xvlog  --incr --relax -prj sca_mul_tb_vlog.prj -log xvlog.log
