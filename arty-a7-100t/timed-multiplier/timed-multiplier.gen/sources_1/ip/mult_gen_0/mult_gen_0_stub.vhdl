...
--               c:/Users/jatin/scalar_ip_multiplier/scalar_ip_multiplier.gen/sources_1/ip/mult_gen_0/mult_gen_0_stub.vhdl
-- Design      : mult_gen_0
...
entity mult_gen_0 is
  ...
  attribute core_generation_info of mult_gen_0 : entity is "mult_gen_0,mult_gen_v12_0_23,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=mult_gen,x_ipVersion=12.0,x_ipCoreRevision=23,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_VERBOSITY=0,C_MODEL_TYPE=0,C_OPTIMIZE_GOAL=1,C_XDEVICEFAMILY=artix7,C_HAS_CE=1,C_HAS_SCLR=0,C_LATENCY=1,C_A_WIDTH=3,C_A_TYPE=1,C_B_WIDTH=4,C_B_TYPE=1,C_OUT_HIGH=58,C_OUT_LOW=0,C_MULT_TYPE=0,C_CE_OVERRIDES_SCLR=0,C_CCM_IMP=0,C_B_VALUE=10000001,C_HAS_ZERO_DETECT=0,C_ROUND_OUTPUT=0,C_ROUND_PT=0}";
...
architecture stub of mult_gen_0 is
  ...
  attribute black_box_pad_pin of stub : architecture is "CLK,A[2:0],B[3:0],CE,P[58:0]";
