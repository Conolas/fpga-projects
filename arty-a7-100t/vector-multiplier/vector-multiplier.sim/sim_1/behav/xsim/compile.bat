...
REM
REM Generated by Vivado on Sat Mar 28 01:07:40 +0530 2026
...
echo "xvlog --incr --relax -prj vec_tb_vlog.prj"
call xvlog  --incr --relax -prj vec_tb_vlog.prj -log xvlog.log
